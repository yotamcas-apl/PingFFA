...
import lol.ysmu.ffa.arenas.ArenaManager;
...
import lol.ysmu.ffa.stats.edit.EditStats;
            ...
            case "kits":
                ...
                switch (kitSubCommand) {
                    ...
                    case "give":
                        ...
                        String p = args[2];
                        Player targetP = Bukkit.getPlayer(p);
                        ...
                        KitManager.giveKit(targetP, kitToGive);
                        String kitGave = main.getConfig().getString("messages.kit_gave");
                        if (!"NONE".equals(kitGave)) {
                            assert kitGave != null;
                            sender.sendMessage(formatColors(prefix + kitGave.replace("%player%", targetP.getName()).replace("%kit%", kitToGive)));
                        }
                        break;
                }
                break;
